...
const Navbar = () => {        
    ...
    <div className="hidden md:flex md:w-64 md:flex-col">
        <div className="flex flex-col flex-grow pt-5 overflow-y-auto text-white bg-gradient-to-r from-purple-500 to-pink-500 ">
            <div className="flex items-center flex-shrink-0 px-4">
                <img className="w-auto h-8"  alt="" /> Save It
            </div>
            ...
            <div className="flex flex-col flex-1 px-3 mt-6">
                <div className="space-y-4">
                    <nav className="flex-1 space-y-2">
                        <a href="https://legacy.reactjs.org/docs/create-a-new-react-app.html" title="" className="flex items-center px-4 py-2.5 text-sm font-medium text-white transition-all duration-200  hover:bg-indigo-600 rounded-lg group">
                            <svg className="flex-shrink-0 w-5 h-5 mr-4 " xmlns="http://www.w3.org/2000/svg"
                        ...
                        <a href="/" className="flex items-center px-4 py-2.5 text-sm font-medium transition-all duration-200  hover:text-white rounded-lg hover:bg-indigo-600 group">
                ...
                <div className="pb-4 mt-20">
                    <button type="button" className="flex items-center justify-between w-full px-4 py-3 text-sm font-medium  transition-all duration-200 rounded-lg hover:bg-gray-100">
